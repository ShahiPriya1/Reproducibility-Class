...
![](LinearModel_HW_files/figure-gfm/unnamed-chunk-3-1.png)<!-- --> The
...
![](LinearModel_HW_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->
...
![](LinearModel_HW_files/figure-gfm/unnamed-chunk-7-1.png)<!-- --> It
looks like there is a difference, to find out we can do a t-test
...
![](LinearModel_HW_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
```
    ...
    ##  V15 - V6     9.17 1.71 33   5.368 <0.0001
...
![](LinearModel_HW_files/figure-gfm/unnamed-chunk-17-1.png)<!-- -->
...
```
    ...
    ## GrowthStage = V8:
    ##  contrast estimate   SE df t.ratio p.value
    ##  C - F       7.167 1.56 66   4.595 <0.0001
    ## 
    ## GrowthStage = V15:
    ##  contrast estimate   SE df t.ratio p.value
